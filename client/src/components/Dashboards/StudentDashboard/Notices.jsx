...
function Notices() {
  ...
  return (
    <div className="w-full h-screen flex flex-col gap-5 items-center justify-center max-h-screen overflow-y-auto">
      <h1 className="text-white font-bold text-5xl">Notice Board</h1>
      <p className="text-white text-xl text-center px-5 sm:p-0">
        All official hostel notices will appear here
      </p>

      <div className="w-full max-w-xl p-4 border rounded-lg shadow sm:p-8 bg-neutral-950 border-neutral-900 drop-shadow-xl overflow-y-auto max-h-70">
        ...
        <div className="flow-root">
          <ul role="list" className="divide-y divide-gray-700">
            {noticeList.length > 0 ? (
              ...
              <p className="text-gray-400 text-sm text-center">No notices available.</p>
            )}
          </ul>
        </div>
      </div>
